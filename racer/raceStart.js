...
class Boost {
    ...
    constructor(x, y, z) {
		...
		/*let materialTriangle = new THREE.MeshNormalMaterial({color: 0xffffff});
		let triangleGeometry = new THREE.Geometry();
		triangleGeometry.vertices.push(new THREE.Vector3( 0.0, 0.0,  -100.0));
		triangleGeometry.vertices.push(new THREE.Vector3(100.0, 0.0,  0.0));
		triangleGeometry.vertices.push(new THREE.Vector3( -100.0, 0.0,  0.0));
		triangleGeometry.faces.push(new THREE.Face3(0,1,2));
		triangleGeometry.computeFaceNormals();
		let triangle = new THREE.Mesh(triangleGeometry, materialTriangle);*/

        this.root.add(box);
        //this.root.add(triangle);
